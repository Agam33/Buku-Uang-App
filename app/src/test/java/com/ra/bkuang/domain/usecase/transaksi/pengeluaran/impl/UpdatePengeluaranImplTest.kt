...
internal class UpdatePengeluaranImplTest {
  private lateinit var updatePengeluaran: UpdatePengeluaran
  ...
  @Test
  fun `UpdatePengeluaran, should success`() = runBlocking {
    updatePengeluaran = UpdatePengeluaranImpl(pengeluaranRepository, akunRepository, budgetRepository)
    ...
    whenever(pengeluaranRepository.update(actualPengeluaran)).thenReturn(Unit)
    ...
    val expectedVal = updatePengeluaran.invoke(actualPengeluaran.toModel(), actualPengeluaran.toModel())
