...
interface TransactionUseCaseModule {
  ...
  @Binds
  @Singleton
  fun bindGetTransferById(getTransferByIdUseCaseImpl: GetTransferByIdUseCaseImpl): GetTransferByIdUseCase

  @Binds
  @Singleton
  fun bindgGetPendapatanById(getPendapatanByIdUseCaseImpl: GetPendapatanByIdUseCaseImpl): GetPendapatanByIdUseCase
